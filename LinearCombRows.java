 ...
 * 
 * Description: This class tests the linearCombRows method.
 * 
 */

public class LinearCombRows {
	public static void main(String[] args) {
		Matrix trixie = new Matrix (4,4); //create trixie
		for(int i=0; i<4; i++) { //for loop from 0 to 4 -- filling up trixie
			for(int j=0; j<4; j++) { //for loop from 0 to 3 --filing up trixie
		...
		trixie.setEntry(3,3, 4); //set the value in the third row and third column of trixie to 4
